...
If you prefer sticking with positives, your integral properties from [section 4.3]({% link calc-for-ap-larson/4.3-reimann-sums-and-definite-integrals.md %}) allow you to flip the interval to flip the sign.
